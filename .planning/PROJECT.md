# Kant AI 사전학습 사이트 (aiEngineerCourse)

## What This Is

2026-09-30 개강하는 Kant AI 엔지니어 교육과정(총 1,056시간, Step 1~3)을 수강할 학습자(사용자 본인)를 위한 사전학습 웹 사이트. 커리큘럼 전체를 쉬운 개념 설명 + 실무 적용 예제로 콘텐츠화하고, 레슨별 완료 체크와 섹션별 진행률, 개강 전(~9/29) 학습 일정표를 제공한다. Next.js + Supabase로 구축하고 Vercel에 배포해 어디서든 접속한다.
...
- 학습자는 2026-09-30 개강 전까지 약 5주(8/25~9/29)를 사전학습에 쓸 수 있고, 하루 4~6시간 투자 가능
