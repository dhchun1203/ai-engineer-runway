...
- [ ] **CONT-07**: 각 레슨의 개념 설명 구간에는 저자가 강조한 핵심 용어를 직접 입력해 채우는 클로즈(빈칸 채우기) 필사가 제공되며, 오답이어도 진행을 막지 않고 정답을 확인할 수 있다
...
- [ ] **TRACK-05**: 클로즈 필사로 채운 빈칸 기록은 Supabase에 저장되어 새 세션·다른 기기에서도 채워진 상태로 유지된다

### 학습 일정 (SCHED)

- [x] **SCHED-01**: 2026-08-28 ~ 09-29, 하루 3시간 이내(하루 1레슨, 토요일 3일만 2레슨) 기준의 일자별 학습 일정표(날짜 → 레슨 매핑)가 제공된다
