...
**Domain:** Personal curriculum-based learning site (course content + progress tracking), Next.js + Supabase + Vercel, Korean UI
...
**Rendering strategy for lesson pages:**
...
**Auth pattern for a single-user progress tracker:**
...
---
*Stack research for: Personal curriculum-based learning site (Next.js + Supabase + Vercel)*
*Researched: 2026-08-24*
